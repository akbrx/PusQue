  ...
  async connectedCallback() {
    try {
      const [resUser, resAll] = await Promise.all([
        fetch('https://serverpusque-production.up.railway.app/antrian/user', { credentials: 'include' }),
        fetch('https://serverpusque-production.up.railway.app/antrian', { credentials: 'include' })
      ]);
